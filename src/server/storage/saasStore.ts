...
export const PLANS: Record<PlanId, PlanDefinition> = {
  free: {
    ...
    description: 'Zero document uploads. Supported PDF operations run locally in your browser.',
    priceMonthly: 0,
    priceYearly: 0,
    ...
    features: [
      ...
      'Designed for merges of up to 5 files',
    ],
    entitlements: {
  ...
  pro: {
    ...
    description: 'Higher-capacity document workflows, large file support, and priority assistance.',
    priceMonthly: 12,
    priceYearly: 108,
    billingInterval: 'monthly',
    ...
    features: [
      ...
      'Designed for higher-capacity merges of up to 50 files',
